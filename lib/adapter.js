...
module.exports = (function () {
  ...
  var adapter = {
    ...
    registerCollection: function(datastoreConfig,entities, cb) {
		...
		console.log('before call the Connection constructor');
    	// connect to database
        new Connection(datastoreConfig, function (err, client) {
			//console.log('call back connection');
			//console.log('client');
			//console.log(client);
			//console.log('the projectId is ' + datastoreConfig.projectId);
          if (err) return cb(err);

		  //console.log('antes de instanciar el arreglo');
          datastores[datastoreConfig.identity].client = client;
		  //console.log(datastores);
		  //console.log('despues de instanciar el arreglo');
		  
		  // Build up a registry of collections
		  //console.log('antes de crear las entidades');
		  Object.keys(entities).forEach(function (key) {
			  var kind = entities[key];
			  datastores[datastoreConfig.identity].entities[key] = new Entities(kind, client);
	      });
		  //console.log(datastores);
		  //console.log('despues de crear las entidades');
